...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00F7FF&size=22&center=true&vCenter=true&width=600&lines=Desenvolvedor+de+Software;Python+%7C+C%23+%7C+JavaScript;HTML+%7C+CSS+%7C+SQL+%26+SQL+Server;Back-end+e+Front-end;Sempre+aprendendo+algo+novo" />
</p>

<p align="center">
  🚀 Tecnologia • 💻 Desenvolvimento • 🛠️ Soluções Digitais
</p>
...
Sou desenvolvedor focado em **criar soluções eficientes, organizadas e escaláveis**, atuando tanto no **back-end** quanto no **front-end**.

Tenho experiência com **desenvolvimento de sistemas**, **APIs**, **automações**, **SQL Server e bancos de dados**, sempre prezando por **código limpo**, **boa lógica** e **boas práticas de engenharia de software**.

💡 Adoro aprender na prática e resolver problemas com tecnologia.
